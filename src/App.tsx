...
function App() {
  ...
  const HomePage = () => (
    <div className="space-y-16">
      {/* Hero Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 p-8">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10">
          <img 
            src="/20250801_0032_Cybercat Alley Encounter_remix_01k1ghn6b0e14bsw2gvcsjkz5v (1).png" 
            alt="Kitt AI - Cybercat in Alley" 
            className="w-full h-96 object-contain rounded-2xl mb-8"
          />
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <img src="/Pixel.jpg" alt="Kitt AI Icon" className="w-12 h-12 rounded-full" />
      ...
      {/* What is Kitt AI */}
      <div className="bg-gradient-to-br from-indigo-900/50 to-purple-900/50 rounded-3xl p-8 backdrop-blur-sm border border-purple-500/20">
        <h2 className="text-4xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">
          What is Kitt AI?
        </h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-200 leading-relaxed">
              Kitt AI is your Personal Crypto Security and Trading Assistant, leveraging machine learning to detect security risks, scams, rugs, and identify good projects. Kitt helps users navigate the crypto ecosystem in a friendly and approachable manner.
            </p>
          ...
          <div className="space-y-4">
            <img src="/totoro2.png" alt="Totoro" className="w-full h-48 object-contain rounded-2xl" />
            <img src="/moon2.png" alt="Moon" className="w-full h-48 object-contain rounded-2xl" />
          </div>
        </div>
      </div>

      {/* $KS Token */}
      <div className="bg-gradient-to-br from-yellow-900/50 to-orange-900/50 rounded-3xl p-8 backdrop-blur-sm border border-yellow-500/20">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-400">
            $KS Token
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            <img src="/SithLord2.png" alt="sith" className="w-full h-64 object-contain rounded-2xl" />
          </div>
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-gray-200">
                ...
                <li className="flex items-center gap-3">
                  <Sparkles className="text-yellow-400" size={20} />
                  Priority access to trading calls
                </li>
                <li className="flex items-center gap-3">
                  <Sparkles className="text-yellow-400" size={20} />
                  Tiered access system (5 tiers)
                </li>
                <li className="flex items-center gap-3">
                  <Sparkles className="text-yellow-400" size={20} />
                  Access to Kitt AI Trading Bot (Coming Soon)
                </li>
          <li className="flex items-center gap-3">
                  <Sparkles className="text-yellow-400" size={20} />
                  Fuel for AI operations
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 rounded-3xl p-8 backdrop-blur-sm border border-blue-500/20 space-y-8">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">5.3 Tier 3: 1,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">5.4 Tier 4: 5,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">5.5 Tier 5: 10,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
        ...
        <section>
          <h2 className="text-3xl font-bold text-blue-400 mb-4">6. Underlying Technologies</h2>
          <p className="text-gray-200 leading-relaxed mb-6">
          ...
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">6.1 Kitt Analysis Engine</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-xl font-semibold text-blue-300 mb-2">Data Collection:</h4>
                  <p className="text-gray-200 leading-relaxed">
                    Aggregates 100+ trending tokens from diverse streaming services for a broad perspective on trending metrics.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-300 mb-2">Pass/Fail Safety & Trust Checks:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-blue-300 mb-2">Scoring System:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-blue-300 mb-2">Social and Meme‐Ability Assessment:</h4>
                  <p className="text-gray-200 leading-relaxed">
                    Measures Twitter sentiment, community engagement, and meme potential.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-blue-300 mb-2">Top 10 Ranking & Chart Interpretation:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">6.2 Kitt Trust Engine</h3>
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">6.3 Kitt Trading Assistant</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">6.4 Kitt Trading Engine</h3>
              <ul className="space-y-2 text-gray-200">
        ...
        <section>
          <h2 className="text-3xl font-bold text-blue-400 mb-4">7. Expanded Notes on Scoring & Synergy</h2>
          
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">Pass/Fail vs. Penalty</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">Synergy Bonuses</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-6">
              <h3 className="text-2xl font-semibold text-purple-300 mb-3">Meme Score</h3>
              <ul className="space-y-2 text-gray-200">
        ...
        <section>
          <h2 className="text-3xl font-bold text-blue-400 mb-4">8. Roadmap & Future Outlook</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-blue-400 mb-4">9. Conclusion</h2>
          <p className="text-gray-200 leading-relaxed mb-6">
          ...
          <div className="bg-red-900/30 rounded-2xl p-6 mt-8 border border-red-500/20">
  ...
  const StarterGuidePage = () => (
    <div className="max-w-4xl mx-auto space-y-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-400">
        Starter Guide
      </h1>
      
      <div className="bg-gradient-to-br from-green-900/50 to-blue-900/50 rounded-3xl p-8 backdrop-blur-sm border border-green-500/20 space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-green-400 mb-4">Kitt AI Telegram Guide</h2>
          <h3 className="text-2xl font-semibold text-blue-300 mb-4">Kitt AI User Guide – How to Access & Use Kitt on Telegram</h3>
          ...
          <div className="bg-black/30 rounded-2xl p-6 mb-6">
            <h3 className="text-2xl font-semibold text-blue-300 mb-3">How to Register & Verify Your Tier</h3>
            <p className="text-gray-200 leading-relaxed mb-4">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-900/50 to-indigo-900/50 rounded-2xl p-6 border border-blue-500/20">
            ...
            <div className="bg-gradient-to-r from-green-900/50 to-teal-900/50 rounded-2xl p-6 border border-green-500/20">
              <h3 className="text-2xl font-semibold text-green-300 mb-3 flex items-center gap-2">
                💎 Tier 3
              </h3>
              <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2">
            ...
            <div className="bg-gradient-to-r from-orange-900/50 to-red-900/50 rounded-2xl p-6 border border-orange-500/20">
              <h3 className="text-2xl font-semibold text-orange-300 mb-3 flex items-center gap-2">
                💎 Tier 4
              </h3>
              <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2">
            ...
            <div className="bg-gradient-to-r from-yellow-900/50 to-amber-900/50 rounded-2xl p-6 border border-yellow-500/20">
          ...
          <div className="bg-black/30 rounded-2xl p-6 mt-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-gray-200 font-mono text-sm ml-4">
  ...
  const TradingBotPage = () => (
    <div className="max-w-4xl mx-auto space-y-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400">
        Trading Bot (Coming soon)
      </h1>
      
      <div className="bg-gradient-to-br from-red-900/50 to-orange-900/50 rounded-3xl p-8 backdrop-blur-sm border border-red-500/20 space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Kitt AI Auto-Trading</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">System Architecture</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Core Functionality</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Complete Data Lifecycle</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Transparency and Reporting</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Security and Reliability</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-red-400 mb-4">Conclusion</h2>
          <p className="text-gray-200 leading-relaxed">
