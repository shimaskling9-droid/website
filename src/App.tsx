...
function App() {
  ...
  const HomePage = () => (
    <div className="space-y-16">
      ...
      {/* $KS Token — VARIAÇÃO TEAL */}
      <div className="bg-gradient-to-br from-teal-900/50 to-emerald-900/50 rounded-3xl p-6 sm:p-8 backdrop-blur-sm border border-emerald-500/25">
        <div className="text-center mb-8">
          <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-emerald-300 tracking-tight">
            $KS Token
          </h2>
        ...
        <div className="grid md:grid-cols-[0.9fr_1.1fr] gap-6 sm:gap-10 items-center">
          ...
          {/* Conteúdo à direita */}
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-6 sm:p-7 ring-1 ring-teal-300/20">
              <h3 className="text-2xl sm:text-3xl font-bold text-teal-300 mb-4">Token Utility</h3>
      ...
      <div className="bg-gradient-to-br from-[#0b1f1a]/60 via-indigo-900/50 to-purple-900/60 rounded-3xl p-6 sm:p-8 backdrop-blur-sm border border-emerald-400/20 space-y-8">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">4.2 Tier 2: 100,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
                <strong className="text-cyan-300">Private, Non‐Personalized Chat:</strong> Interact with Kitt for extended call lists (Top 10 picks for 2hr and 4hr).
              </p>
              <p className="text-gray-200 leading-relaxed">
                <strong className="text-cyan-300">1hr Top Pick & Analysis:</strong> Access a special 1hr time‐window pick for quick trading opportunities or additional insights.
              </p>
            </div>

            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">5.3 Tier 3: 1,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
                <strong className="text-cyan-300">Entry‐Level Access to Kitt's Trading Assistant:</strong>
              </p>
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">5.4 Tier 4: 5,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
                <strong className="text-cyan-300">Primary‐Level Access to Kitt's Trading Assistant:</strong>
              </p>
              <ul className="space-y-2 text-gray-200 ml-6">
                <li><strong className="text-cyan-300">Real‐Time Calls:</strong> Not limited by specific timeframes. Kitt alerts you when something looks good.</li>
                <li><strong className="text-cyan-300">Customizable Risk Metrics:</strong> Adjust certain parameters (buy/sell ratio thresholds, volume requirements, etc.), and Kitt explains how these changes affect calls.</li>
                <li>Note: Real‐time calls themselves remain as is, but daily calls or recommendations can be customized.</li>
                <li><strong className="text-cyan-300">Weekly HODL:</strong> Access a curated list of high‐cap holds for long‐term gains.</li>
                <li>Future Access to Kitt Trading Engine (launch Q2 2025).</li>
              </ul>
            </div>

            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">5.5 Tier 5: 10,000,000+ KS</h3>
              <p className="text-gray-200 leading-relaxed mb-3">
                <strong className="text-cyan-300">Premier‐Level Access to Kitt's Trading Assistant:</strong>
              </p>
              <ul className="space-y-2 text-gray-200 ml-6">
                <li><strong className="text-cyan-300">Early Access to All Production Features:</strong> Beta‐test and propose new features (though acceptance is not guaranteed).</li>
                <li><strong className="text-cyan-300">Fully Customizable Real‐Time Calls:</strong> Adjust all available metrics for risk tolerance or trading style.</li>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">6.1 Kitt Analysis Engine</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-emerald-300 mb-2">Data Collection:</h4>
                  <p className="text-gray-200 leading-relaxed">
                    Aggregates 100+ trending tokens from diverse streaming services for a broad perspective on trending metrics.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-emerald-300 mb-2">Pass/Fail Safety & Trust Checks:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-emerald-300 mb-2">Scoring System:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-emerald-300 mb-2">Social and Meme‐Ability Assessment:</h4>
                  <p className="text-gray-200 leading-relaxed">
                    Measures Twitter sentiment, community engagement, and meme potential.
                  </p>
                </div>
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-emerald-300 mb-2">Top 10 Ranking & Chart Interpretation:</h4>
                  <ul className="space-y-2 text-gray-200 ml-6">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">6.2 Kitt Trust Engine</h3>
              <ul className="space-y-2 text-gray-200">
                <li><strong className="text-emerald-300">Holder Data Caching:</strong> Logs and stores wallet data from every Kitt Analysis pull.</li>
                <li><strong className="text-emerald-300">Scammer/Pump‐and‐Dump Detection:</strong> Compares known malicious or suspicious wallets, identifies bundling patterns, and checks token creator history.</li>
                <li><strong className="text-emerald-300">Scoring & Passing Criteria:</strong> Assigns a "trust score" to weed out projects with questionable tokenomics or wallet distributions before they enter Kitt's calls.</li>
              </ul>
            </div>

            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">6.3 Kitt Trading Assistant</h3>
              <ul className="space-y-2 text-gray-200">
                <li><strong className="text-emerald-300">User‐Focused Interface:</strong> Integrates Analysis Engine, Trading Engine, and Trust Engine to give personalized guidance.</li>
                <li><strong className="text-emerald-300">Telegram Integration:</strong> Provides real‐time data, allows users to set risk profiles, and offers multiple timeframes for informed decisions.</li>
                <li><strong className="text-emerald-300">Future Trading Engine Compatibility:</strong> Will seamlessly link to the Kitt Trading Engine for automated strategies (Q2 2025 and beyond).</li>
              </ul>
            </div>

            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">6.4 Kitt Trading Engine</h3>
              <ul className="space-y-2 text-gray-200">
                <li><strong className="text-emerald-300">Automated & User‐Controlled Trading:</strong> Users can set profit targets, risk levels, position sizes, and define advanced strategies.</li>
                <li><strong className="text-emerald-300">RPC Upgrades & Sniping Features:</strong> As the ecosystem grows, faster transaction speeds and specialized sniping tools will be introduced (planned Q3 2025, subject to project success).</li>
                <li><strong className="text-emerald-300">Multi‐Chain Support:</strong> Expanding capabilities to different blockchains is slated for Q2 2025.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">Pass/Fail vs. Penalty</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">Synergy Bonuses</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-semibold text-cyan-300 mb-3">Meme Score</h3>
              <ul className="space-y-2 text-gray-200">
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-2xl font-semibold text-cyan-300 mb-3">Q2 2025:</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-2xl font-semibold text-cyan-300 mb-3">Q3 2025:</h3>
              <ul className="space-y-2 text-gray-200">
            ...
            <div className="bg-black/30 rounded-2xl p-5 sm:p-6">
              <h3 className="text-2xl font-semibold text-cyan-300 mb-3">Ongoing:</h3>
              <ul className="space-y-2 text-gray-200">
  ...
  const StarterGuidePage = () => (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-br from-[#0b1f1a]/60 via-blue-900/50 to-indigo-900/60 rounded-3xl p-6 sm:p-8 backdrop-blur-sm border border-emerald-400/20 space-y-8">
        ...
        <div className="space-y-6"> <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 rounded-2xl p-5 sm:p-6 border border-purple-500/20"> <h3 className="text-xl sm:text-2xl font-semibold text-purple-300 mb-3 flex items-center gap-2"> 💎 Tier 1 </h3> <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2"> 💰 Requirement: 1KS+ </p> <div className="mb-3"> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 📌 Features: </p> <div className="ml-4"> <p className="text-green-300 font-semibold mb-2"> ✅ Automatic 2H & 4H Calls </p> <ul className="space-y-1 text-gray-200 ml-4 text-sm"> <li>Pick a concise, metric‐based top trending token that has passed basic safety, volume, price, and growth checks</li> <li>Includes tokens that have existed for at least 2 or 4 hours</li> <li>Graded based on 2H/4H metrics</li> <li>Our safest calls ideal for low-risk traders</li> </ul> </div> </div> </div> <div className="bg-gradient-to-r from-blue-900/50 to-indigo-900/50 rounded-2xl p-5 sm:p-6 border border-blue-500/20"> <h3 className="text-xl sm:text-2xl font-semibold text-blue-300 mb-3 flex items-center gap-2"> 💎 Tier 2 </h3> <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2"> 💰 Requirement: 100,000+ KS </p> <div className="mb-3"> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 📌 Features: </p> <div className="ml-4"> <p className="text-green-300 font-semibold mb-2"> ✅ Historical Data for Automatic 2H & 4H Calls </p> <ul className="space-y-1 text-gray-200 ml-4 text-sm"> <li>Unlike Tier 1 calls, these leverage historical data and factor in past liquidity shifts</li> <li>Safe calls ideal for low-risk traders</li> </ul> </div> </div> </div> <div className="bg-gradient-to-r from-green-900/50 to-teal-900/50 rounded-2xl p-5 sm:p-6 border border-green-500/20"> <h3 className="text-xl sm:text-2xl font-semibold text-green-300 mb-3 flex items-center gap-2"> 💎 Tier 3 </h3> <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2"> 💰 Requirement: 1,000,000+ KS </p> <div className="mb-3"> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 📌 Features: </p> <div className="ml-4 space-y-3"> <p className="text-green-300 font-semibold"> ✅ Everything from Tier 2 </p> <p className="text-green-300 font-semibold"> ✅ Ask Kitt Questions Directly – Token analysis, trends, and market insights </p> <div> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 🔍 Example Usage: </p> <ul className="space-y-1 text-gray-200 ml-4 text-sm"> <li>Can you explain how priority fees works on Abstract as well as slippage?</li> <li>Give me a report on &lt;token address&gt;</li> <li>Analyze this chart in details, what are some possible resistance points, entry points and what should my stop loss be? (Please attach chart image)</li> <li>Analyze this chart and give me a prediction for the next 4 hours. Be as detailed as possible. (Please attach chart image)</li> </ul> </div> </div> </div> </div> <div className="bg-gradient-to-r from-orange-900/50 to-red-900/50 rounded-2xl p-5 sm:p-6 border border-orange-500/20"> <h3 className="text-xl sm:text-2xl font-semibold text-orange-300 mb-3 flex items-center gap-2"> 💎 Tier 4 </h3> <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2"> 💰 Requirement: 5,000,000+ KS </p> <div className="mb-3"> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 📌 Features: </p> <div className="ml-4 space-y-3"> <p className="text-green-300 font-semibold"> ✅ Everything from Tier 3 </p> <p className="text-green-300 font-semibold"> ✅ Automatic 1H Calls (Pull in newer contracts and analyze 1H metrics) </p> <ul className="space-y-1 text-gray-200 ml-4 text-sm"> <li>Early access to new tokens</li> <li>High risk, high reward</li> </ul> </div> </div> </div> <div className="bg-gradient-to-r from-yellow-900/50 to-amber-900/50 rounded-2xl p-5 sm:p-6 border border-yellow-500/20"> <h3 className="text-2xl font-semibold text-yellow-300 mb-3 flex items-center gap-2"> 💎 Tier 5 </h3> <p className="text-yellow-300 font-semibold mb-3 flex items-center gap-2"> 💰 Requirement: 10,000,000+ KS </p> <div className="mb-3"> <p className="text-blue-300 font-semibold mb-2 flex items-center gap-2"> 📌 Features: </p> <div className="ml-4 space-y-3"> <p className="text-green-300 font-semibold"> ✅ Everything from Tier 4 </p> <p className="text-green-300 font-semibold"> ✅ On Demand calls at any Timeframe (30m, 1h, 2h, 4h, 8h, 24h) </p> <p className="text-green-300 font-semibold"> ✅ Beta Testing: Clustermap, Watch Token, and Watch Wallet </p> </div> </div> </div> </div> <div className="bg-black/30 rounded-2xl p-5 sm:p-6 mt-8"> <h3 className="text-xl sm:text-2xl font-semibold text-blue-300 mb-3 flex items-center gap-2"> 📊 Timeframe Details: </h3> <ul className="space-y-2 text-gray-200"> <li><strong className="text-blue-300">2H, 4H, 8H, and 24H Calls:</strong> Only include tokens older than the selected timeframe</li> <li><strong className="text-blue-300">30m & 1H Calls:</strong> No contract age requirement! These calls can include brand-new contracts that just launched, making them the earliest entries possible</li> <li className="text-orange-300">High risk, high reward</li> </ul> </div> <div className="bg-black/30 rounded-2xl p-5 sm:p-6 mt-6"> <h3 className="text-xl sm:text-2xl font-semibold text-purple-300 mb-3 flex items-center gap-2"> 🔬 Advanced Features: </h3> <ul className="space-y-3 text-gray-200"> <li><strong className="text-purple-300">Clustermap:</strong> Uses advanced graph analysis to detect coordinated wallet clusters, identifying bot activity, suspicious funding sources, and pre-planned dumps</li> <li><strong className="text-purple-300">Watch Token:</strong> Track big buys, sells, liquidity shifts, and whale moves for any token. Get instant alerts on real-time market events</li> <li><strong className="text-purple-300">Watch Wallet:</strong> Monitor key wallets and get instant alerts on high-value transactions and new token interactions</li> </ul> </div> <div className="bg-black/30 rounded-2xl p-5 sm:p-6 mt-6"> <h3 className="text-xl sm:text-2xl font-semibold text-green-300 mb-3 flex items-center gap-2"> 🔍 Commands/Example Usage: </h3> <div className="space-y-4"> <div className="overflow-x-auto"> <ul className="space-y-1 text-gray-200 font-mono text-sm min-w-[32rem]"> <li>/help</li> <li>/calls &lt;timeframe&gt; [chain]</li> <li>/clustermap &lt;token address&gt;</li> <li>/watchtoken &lt;token address&gt;</li> <li>/watchwallet &lt;wallet address&gt;</li> <li>/tokenstop - Stop tracking the token you are watching</li> <li>/walletstop - Stop tracking the wallet you are watching</li> </ul> </div> <div className="overflow-x-auto"> <p className="text-blue-300 font-semibold mb-2">Examples:</p> <ul className="space-y-1 text-gray-200 font-mono text-sm ml-4 min-w-[32rem]"> <li>/calls 2hr - Get 2 hour calls (for Solana by default)</li> <li>/calls 1hr ethereum - Get 1 hour calls for Ethereum</li> <li>/clustermap 0x1234567890123456789012345678901234567890 - Analyze a specific token's cluster</li> <li>/watchtoken 0x1234567890123456789012345678901234567890 - Track a specific token</li> <li>/watchwallet 0x1234567890123456789012345678901234567890 - Track a specific wallet</li> </ul> </div> </div> </div> </section> </div> </div> );
